...
const outAppPath = "heep-hong-it-eworkflow-option-a-app-def.v7.json";
const outFormDefPath = "heep-hong-it-eworkflow-option-a-purchase-requisition-approval-form-def.v7.json";
const reportPath = "heep-hong-it-eworkflow-option-a-generation-report.v7.json";
...
fs.writeFileSync(reportPath, `${JSON.stringify({
  ...
  diagnosticPurpose: "v7 removes all child list sample records to isolate whether imported ListDatas rows are causing the Yeeflow datas/query 400 runtime error.",
