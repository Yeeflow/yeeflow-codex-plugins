...
const outAppPath = "heep-hong-it-eworkflow-option-a-app-def.v5.json";
const outFormDefPath = "heep-hong-it-eworkflow-option-a-purchase-requisition-approval-form-def.v5.json";
const reportPath = "heep-hong-it-eworkflow-option-a-generation-report.v5.json";
...
function makeDataListViewLayout(list, visibleFieldNames = null) {
  ...
  return JSON.stringify({
    layout: list.Defs.map((field, index) => ({
