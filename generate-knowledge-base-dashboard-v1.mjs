...
const outputAppDefPath = "knowledge-base-generated-v4-app-def.json";
const outputResourcePath = "knowledge-base-generated-v4-resource.json";
const outputReportPath = "knowledge-base-generated-v4-generation-report.json";

const oldFamily = "267";
const family = "273";
const generatedAt = "2026-05-13 23:35:00";
const appTitle = "Knowledge Base Generated v4";
const appDescription = "Simplified generated Knowledge Base app with local categories, articles, dashboard search, and Collection cards.";
