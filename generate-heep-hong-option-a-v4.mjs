...
const outAppPath = "heep-hong-it-eworkflow-option-a-app-def.v4.json";
const outFormDefPath = "heep-hong-it-eworkflow-option-a-purchase-requisition-approval-form-def.v4.json";
const reportPath = "heep-hong-it-eworkflow-option-a-generation-report.v4.json";
