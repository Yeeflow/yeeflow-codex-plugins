...
const outputAppDefPath = "generated-dashboard-collection-table-v2-app-def.json";
const outputResourcePath = "generated-dashboard-collection-table-v2-resource.json";
const outputReportPath = "generated-dashboard-collection-table-v2-generation-report.json";

const oldFamily = "248";
const family = "261";
const generatedAt = "2026-05-13 15:00:00";
const appTitle = "Generated Dashboard Collection Table v2";
const appDescription = "Minimal dashboard Collection test with one table-style Collection bound to local Support Tickets.";
...
function tablePage(rootId, dashboardId, supportTicketsListId, appId) {
  ...
  const headerGrid = control("flex_grid", "Table header", {
    layout: { cols: [null, gridColumns], gap: [null, 0] },
    common: {
    ...
    headerCell("Team"),
    headerCell("Created")
  ], { nv_label: "Table header of the generated collection" });
  ...
  ], { nv_label: "Table item of the collection each item" });
  ...
  return {
    children: [
      control("container", "Container", {
        ...
        control("container", "Container", {
          ...
          heading("Tickets Collection Table", "h2-bold"),
          text("<p>Generated table-style Collection proving one repeated row per Support Ticket.</p>")
    ...
    attrs: {},
    title: "Tickets Collection Table",
    ver: 2,
    filterVars: [],
    tempVars: [],
    exts: [],
...
dashboard.Title = "Tickets Collection Table";
  ...
  sort: [
    {
      ...
      DisplayName: "Tickets Collection Table"
    },
    {
      AppID: appId,
      ListID: dashboard.LayoutID,
