...
const outputAppDefPath = "knowledge-base-lookup-v9-text4-only-app-def.json";
const outputResourcePath = "knowledge-base-lookup-v9-text4-only-resource.json";
const outputReportPath = "knowledge-base-lookup-v9-text4-only-generation-report.json";

const oldFamily = "267";
const family = "278";
const generatedAt = "2026-05-14 02:45:00";
const appTitle = "Knowledge Base Lookup v9 Text4 Only";
const appDescription = "Knowledge Base lookup isolation package based on the runtime-proven v4 shape, adding only a blank Articles.Text4 category lookup with no Text3 placeholder.";
...
const articleFields = [
  ...
  makeLookupField(articlesListId, `${family}0020000000001004`, "Text4", "Category", categoriesListId, rootId)
];
...
fs.writeFileSync(outputReportPath, `${JSON.stringify({
  ...
  includedPatterns: [
    ...
    "local article-to-category lookup metadata in source-like Text4 slot",
