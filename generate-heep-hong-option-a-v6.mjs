...
const outAppPath = "heep-hong-it-eworkflow-option-a-app-def.v6.json";
const outFormDefPath = "heep-hong-it-eworkflow-option-a-purchase-requisition-approval-form-def.v6.json";
const reportPath = "heep-hong-it-eworkflow-option-a-generation-report.v6.json";
