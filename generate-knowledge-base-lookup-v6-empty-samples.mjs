...
const outputAppDefPath = "knowledge-base-lookup-v6-empty-samples-app-def.json";
const outputResourcePath = "knowledge-base-lookup-v6-empty-samples-resource.json";
const outputReportPath = "knowledge-base-lookup-v6-empty-samples-generation-report.json";

const oldFamily = "267";
const family = "275";
const generatedAt = "2026-05-14 00:45:00";
const appTitle = "Knowledge Base Lookup v6 Empty Samples";
const appDescription = "Knowledge Base lookup isolation package with local lookup metadata and blank article lookup sample values.";
