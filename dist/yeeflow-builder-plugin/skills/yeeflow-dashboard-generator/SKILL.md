...
Collection/Kanban actions runtime proof package: `docs/studies/collection-kanban-actions-runtime-proof.md` records the focused generated package `collection-kanban-actions-runtime-proof.v1.yap`. On 2026-05-28 the user confirmed import/open/action execution for one Data List, one Dashboard Collection, one Dashboard Kanban, local item actions, checked/unchecked selection icons, selected count, and bulk update/delete actions. Preserve the narrow proof boundary for this generated package and tested actions only.
