...
let validateWorkflowActionShapes;
let loadControlFieldSchemas;
let validateFieldAgainstSchema;

try {
  ({ validateWorkflowActionShapes } = require("./workflow-action-config-validator"));
} catch {
  ({ validateWorkflowActionShapes } = require("../../yeeflow-application-generator/scripts/workflow-action-config-validator"));
}

try {
  ({ loadControlFieldSchemas, validateFieldAgainstSchema } = require("./yeeflow-control-field-schema-utils"));
} catch {
  ({ loadControlFieldSchemas, validateFieldAgainstSchema } = require("../../yeeflow-application-generator/scripts/yeeflow-control-field-schema-utils"));
}
