...
After installation, ask Codex to confirm the installed Yeeflow Builder Plugin version. The expected RC version is `0.6.4`.
...
- Wrong version: check the Git ref is `yeeflow-builder-plugin-v0.6.4-rc1` for RC smoke testing. Use `yeeflow-builder-plugin-v0.6.4` only after the final tag is created.
