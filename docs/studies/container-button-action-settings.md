...
Source export path: `/Users/Renger/Downloads/AP Approval Demo v3.yap`
...
```text
node scripts/inspect-container-button-actions.mjs "/Users/Renger/Downloads/AP Approval Demo v3.yap" --page "AP Approval Dashboard"
```
