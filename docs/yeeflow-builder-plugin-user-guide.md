...
After installation, ask Codex to confirm the installed Yeeflow Builder Plugin version. The expected version is `0.6.4`.
...
- Wrong version: check the Git ref is `yeeflow-builder-plugin-v0.6.4` for the final v0.6.4 release.
