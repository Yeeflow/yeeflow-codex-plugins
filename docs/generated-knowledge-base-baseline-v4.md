...
- The source template uses `Articles.Text4` for Category lookup; v8 validates and round-trips with that source-like slot, but runtime proof is still pending.
