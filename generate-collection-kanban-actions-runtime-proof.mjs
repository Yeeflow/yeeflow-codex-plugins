...
const OUT_PACKAGE = "collection-kanban-actions-runtime-proof.v1.yap";
const OUT_RESOURCE = ".tmp/collection-kanban-actions-runtime-proof.v1.resource.json";
const OUT_DATA = ".tmp/collection-kanban-actions-runtime-proof.v1.app-def.json";
const OUT_REPORT = ".tmp/collection-kanban-actions-runtime-proof.v1.generation-report.json";
const DOWNLOADS_COPY = "/Users/Renger/Downloads/collection-kanban-actions-runtime-proof.v1.yap";
...
const APP_ID = 41;
const FAMILY = 7471000000000000000n;
...
function collectGeneratedIds(value, ids = new Set()) {
  if (typeof value === "string") {
    for (const match of value.matchAll(/\b747100\d{9,}\b/g)) ids.add(match[0]);
    return ids;
  }
