...
const outputAppDefPath = "generated-dashboard-collection-grid-v7-app-def.json";
const outputResourcePath = "generated-dashboard-collection-grid-v7-resource.json";
const outputReportPath = "generated-dashboard-collection-grid-v7-generation-report.json";

const oldFamily = "248";
const family = "266";
const generatedAt = "2026-05-13 19:00:00";
const appTitle = "Generated Dashboard Collection Grid v7";
const appDescription = "Minimal dashboard Collection test with one local Support Tickets list, one card/grid Collection control, and a New Ticket action button.";
        ...
        control("container", "Container", {
          ...
          control("container", "Container", {
            ...
            control("container", "Container", {
              ...
              heading("Tickets Collection Grid", "h2-bold"),
              text("<p>Generated card/grid Collection proving local Support Tickets card layout and a local New Ticket action button.</p>")
...
dashboard.Title = "Tickets Collection Grid";
  ...
  sort: [
    {
      ...
      DisplayName: "Tickets Collection Grid"
    },
    {
      AppID: appId,
      ListID: dashboard.LayoutID,
