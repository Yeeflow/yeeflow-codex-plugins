...
const outputAppDefPath = "knowledge-base-lookup-v8-text4-lookup-app-def.json";
const outputResourcePath = "knowledge-base-lookup-v8-text4-lookup-resource.json";
const outputReportPath = "knowledge-base-lookup-v8-text4-lookup-generation-report.json";

const oldFamily = "267";
const family = "277";
const generatedAt = "2026-05-14 01:25:00";
const appTitle = "Knowledge Base Lookup v8 Text4 Lookup";
const appDescription = "Knowledge Base lookup isolation package with the article category lookup moved to the source-like Text4 slot, blank lookup sample values, and the lookup field hidden from the Articles list view.";
...
const articleFields = [
  ...
  makeField(articlesListId, `${family}0020000000001004`, "Text3", "Feature Image Placeholder", "input", { placeholder: "Image placeholder deferred" }),
  makeLookupField(articlesListId, `${family}0020000000001005`, "Text4", "Category", categoriesListId, rootId)
];
...
fs.writeFileSync(outputReportPath, `${JSON.stringify({
  ...
  includedPatterns: [
    ...
    "local article-to-category lookup metadata",
    "blank article lookup sample values",
    "article category lookup uses source-like Text4 slot",
    "lookup field hidden from the Articles list view",
