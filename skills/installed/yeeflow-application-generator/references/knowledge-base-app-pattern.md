...
- v10 adds `Articles.Text4` as a plain input field and imports successfully, but app-open/list runtime verification is pending because browser control failed during the smoke test. Do not treat the plain `Text4` field slot as proven until v10 opens and both lists render.
