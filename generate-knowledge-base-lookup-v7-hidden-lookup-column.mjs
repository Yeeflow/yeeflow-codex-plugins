...
const outputAppDefPath = "knowledge-base-lookup-v7-hidden-lookup-column-app-def.json";
const outputResourcePath = "knowledge-base-lookup-v7-hidden-lookup-column-resource.json";
const outputReportPath = "knowledge-base-lookup-v7-hidden-lookup-column-generation-report.json";

const oldFamily = "267";
const family = "276";
const generatedAt = "2026-05-14 01:05:00";
const appTitle = "Knowledge Base Lookup v7 Hidden Lookup Column";
const appDescription = "Knowledge Base lookup isolation package with local lookup metadata, blank article lookup sample values, and the lookup field hidden from the Articles list view.";
