...
const outputAppDefPath = "generated-dashboard-collection-search-v4-app-def.json";
const outputResourcePath = "generated-dashboard-collection-search-v4-resource.json";
const outputReportPath = "generated-dashboard-collection-search-v4-generation-report.json";

const oldFamily = "248";
const family = "263";
const generatedAt = "2026-05-13 16:00:00";
const appTitle = "Generated Dashboard Collection Search v4";
const appDescription = "Minimal dashboard Collection test with table-style search-filter binding.";
