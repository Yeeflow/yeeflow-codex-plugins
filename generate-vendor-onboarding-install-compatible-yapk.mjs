...
const OUT = "/Users/Renger/Downloads/vendor-onboarding-compliance-management.v1.2-install-compatible.yapk";
const REPORT = ".tmp/vendor-onboarding-compliance-management/vendor-onboarding-compliance-management.v1.2-install-compatible.report.json";
...
async function main() {
  ...
  let appText = JSON.stringify(JSON.parse(fs.readFileSync(APP_PACKAGE, "utf8")));
  ...
  const unsigned = {
    ...
    IconUrl: ICON_URL,
    Resource: resource,
    Notes: "Install-compatibility V1.2 candidate: API-issued IDs, text-level remap, Yeeflow-style Brotli flush encoding, server-signed and verified. Manual runtime import proof is required.",
