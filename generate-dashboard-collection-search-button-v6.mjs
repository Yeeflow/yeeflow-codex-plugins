...
const outputAppDefPath = "generated-dashboard-collection-search-button-v6-app-def.json";
const outputResourcePath = "generated-dashboard-collection-search-button-v6-resource.json";
const outputReportPath = "generated-dashboard-collection-search-button-v6-generation-report.json";

const oldFamily = "248";
const family = "265";
const generatedAt = "2026-05-13 18:00:00";
const appTitle = "Generated Dashboard Collection Search Button v6";
const appDescription = "Minimal dashboard Collection test with table-style search-filter binding, hidden grid captions, and a New Ticket action button.";
...
function tablePage(rootId, dashboardId, supportTicketsListId, appId) {
  ...
  return {
      ...
      control("container", "Container", {
        ...
        control("container", "Container", {
          style: {
            ...
            align_items: [null, "flex-start", null, "stretch"],
            gap: [null, "--sp--s200"]
          }
        }, [
          control("container", "Container", {
            ...
            heading("Tickets Collection Search Button", "h2-bold"),
            text("<p>Generated table-style Collection proving search-filter binding, hidden table captions, and a local New Ticket action button.</p>")
          ], { nv_label: "Collection table page title block" }),
          newTicketButton(rootId, supportTicketsListId, appId)
        ], { nv_label: "Collection table page header with action" }),
        control("container", "Container", {
          style: {
            direction: [null, "row", null, "column"],
    ...
    attrs: {},
    title: "Tickets Collection Search Button",
    ver: 2,
    filterVars: [
      {
        idx: id(),
...
dashboard.Title = "Tickets Collection Search Button";
  ...
  sort: [
    {
      ...
      DisplayName: "Tickets Collection Search Button"
    },
    {
      AppID: appId,
      ListID: dashboard.LayoutID,
