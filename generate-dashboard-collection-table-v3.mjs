...
const outputAppDefPath = "generated-dashboard-collection-table-v3-app-def.json";
const outputResourcePath = "generated-dashboard-collection-table-v3-resource.json";
const outputReportPath = "generated-dashboard-collection-table-v3-generation-report.json";

const oldFamily = "248";
const family = "262";
const generatedAt = "2026-05-13 15:30:00";
const appTitle = "Generated Dashboard Collection Table v3";
